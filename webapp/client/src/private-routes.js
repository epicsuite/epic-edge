...
const AdminUsers = React.lazy(() => import('./epic/edge/um/admin/Users'))
const AdminUploads = React.lazy(() => import('./epic/edge/um/admin/Uploads'))
const AdminProjects = React.lazy(() => import('./epic/edge/um/admin/Projects'))
const AdminProjectPage = React.lazy(() => import('./epic/edge/project/results/projectPage/Admin'))
