...
import { Episcope } from './forms/Episcope'
import { HtmlText } from 'src/edge/common/HtmlText'
import { episcope, components } from './defaults'
...
const Main = (props) => {
  ...
  const [workflow, setWorkflow] = useState('episcope')
  ...
  const onSubmit = () => {
    ...
    let params = { input: input, app: 'episcope' }
    setSubmitting(true)
