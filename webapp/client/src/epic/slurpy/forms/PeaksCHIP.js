...
export const PeaksCHIP = (props) => {
  const componentName = 'peaksCHIP'
        ...
        <Collapse isOpen={!collapseParms} id={'collapseParameters-' + props.name}>
          <CardBody>
            ...
            <FileInput
              ...
              setParams={setFileInput}
              isValidFileInput={isValidFileInput}
              text={components[componentName].inputs['controlFile'].text}
              tooltip={components[componentName].inputs['controlFile']['fileInput'].tooltip}
              enableInput={components[componentName].inputs['controlFile']['fileInput'].enableInput}
              placeholder={components[componentName].inputs['controlFile']['fileInput'].placeholder}
              dataSources={components[componentName].inputs['controlFile']['fileInput'].dataSources}
              fileTypes={components[componentName].inputs['controlFile']['fileInput'].fileTypes}
              viewFile={components[componentName].inputs['controlFile']['fileInput'].viewFile}
              isOptional={components[componentName].inputs['controlFile']['fileInput'].isOptional}
              cleanupInput={
                components[componentName].inputs['controlFile']['fileInput'].cleanupInput
              }
            />
            <br></br>
          </CardBody>
