                  ...
                  {workflow === '4dgb' && (
                    <>
                      ...
                      <DataSets
                        setParams={setComponentParams}
                        title={
                          inputComponents['datasets']
                            ? inputComponents['datasets'].text
                            : 'Datasets'
                        }
                        isValid={
                          inputComponents['datasets']
                            ? inputComponents['datasets'].validForm
                            : false
                        }
                        errMessage={
                          inputComponents['datasets']
                            ? inputComponents['datasets'].errMessage
                            : null
                        }
                      />
                      <Tracks
                        setParams={setComponentParams}
                        title={
                          inputComponents['tracks'] ? inputComponents['tracks'].text : 'Tracks'
                        }
                        isValid={
                          inputComponents['tracks'] ? inputComponents['tracks'].validForm : true
                        }
                        errMessage={
                      ...
                      <Bookmarks
                        setParams={setComponentParams}
                        title={
                          inputComponents['bookmarks']
                            ? inputComponents['bookmarks'].text
                            : 'Bookmarks'
                        }
                        isValid={
                          inputComponents['bookmarks']
                            ? inputComponents['bookmarks'].validForm
                            : true
                        }
                        errMessage={
                          inputComponents['bookmarks']
                            ? inputComponents['bookmarks'].errMessage
                            : null
                        }
                      />
                    </>
